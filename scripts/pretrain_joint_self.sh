...
deepspeed --include=localhost:0,1,2,3,4,5,6,7 llava/train/train_joint_1st.py \
    ...
    --image_folder /root/jinyfeng/datas/llava-grounding/ConceptualCaptionsFiltered/ \
    --vision_tower /root/jinyfeng/models/LLaVa/openai/clip-vit-large-patch14 \
    --pretrain_mm_mlp_adapter /root/jinyfeng/models/LLaVa/llava-v1.5-7b/mm_projector.bin \
